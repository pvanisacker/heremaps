...
urlpatterns = patterns('',
    ...
    url(r'^hereshapemap_js_custom3/$', render('heremaps:hereshapemap_js_custom3.html'), name='hereshapemap_js_custom3'),
    url(r'^hereshapemap_js_custom4/$', render('heremaps:hereshapemap_js_custom4.html'), name='hereshapemap_js_custom4'),
